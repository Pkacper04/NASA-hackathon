...
namespace Histhack.Core.SaveLoadSystem
{
    public static class SaveSystem
    {
        ...
        private static string GetRawData(string path)
        {
            ...
            CryptoStream oStream = DataManager.Instance.Encrypter.CreateDecryptoCryptoStream(fs, CryptoStreamMode.Read);
        ...
        public static void Save<T>(T savingValue, string savingPath, SaveDirectories additionalSaveDirectory = SaveDirectories.None)
        {
            ...
            CryptoStream iStream = DataManager.Instance.Encrypter.CreateEncryptoCryptoStream(fs, CryptoStreamMode.Write);
